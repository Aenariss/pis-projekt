...
/**
 * Data model for order user info.
 */
@Entity
@Table(name = "OrderUserInfo")
@NamedQuery(name = "OrderUserInfo.findAll", query = "SELECT oui FROM OrderUserInfo oui")
// Order user info has firstname, surname, phone, email
