...
public class ProductDescription {
    ...
    private long id;
        ...
        public ProductDescription(double price, String name, String description, String ISBN, int pages, BookAuthor author, List<Category> categories, Language language, Discount discount) {
            this.price = price;
            this.name = name;
