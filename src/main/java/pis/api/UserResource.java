...
import pis.data.PasswordChangeRequest;
import pis.data.ProfileRequest;
...
public class UserResource {
    ...
    private Response setProfileBody(ProfileRequest r,  RegisteredUser u) {
        ...
        u.setEmail(r.getEmail()); // If this was a real app, there'd have to be some sort of validity check - wait for confirmation from origin email etc..
